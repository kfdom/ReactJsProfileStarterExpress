	...
	var ProfilePage = function (_React$Component) {
	  ...
	  function ProfilePage(props) {
	    ...
	    _this.formSubmit = function () {
	      ...
	      if (_this.state.profiles.length != 0) {
	        newId = _this.state.profiles[_this.state.profiles.length - 1].id + 1;
	      } else {
	        newId = 1;
	      }
	      ...
	      var newObj = {
	        ...
	        over18: _this.state.over18
	      };

	      var newProfiles = _this.state.profiles;
	    ...
	    _this.deleteRecord = function (index) {
	    ...
	    _this.updateRecord = function (index, firstName, lastName, gender, over18) {
	      _this.state.profiles[index].firstName = firstName;
	      _this.state.profiles[index].lastName = lastName;
	      _this.state.profiles[index].gender = gender;
	      _this.state.profiles[index].over18 = over18;
	  ...
	  _createClass(ProfilePage, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "button",
	          { className: "btn btn-primary btn-block", onClick: this.formSubmit },
	          " ",
	          "Submit",
	          " "
	        ),
	        ...
	        _react2.default.createElement("br", null),
	        _react2.default.createElement("br", null),
	        _react2.default.createElement(_ProfileTableList2.default, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProfileTableList = function (_React$Component) {
	  ...
	  function ProfileTableList(props) {
	    ...
	    _this.saveEditRecord = function (index) {

	      _this.setState({
	        editRow: ''
	      });

	      _this.props.updateRecord(index, _this.state.firstName, _this.state.lastName, _this.state.gender, _this.state.over18);
	    };
